		...
		jb1.addActionListener(new ActionListener() 
		{
			...
			public void actionPerformed(ActionEvent e) 
			{
				...
				try{
					...
					Connection conn = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/naman","root", "root3111");
					if(conn!=null)
					{
		...
		jb3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try{
					...
					if(conn!=null){
						Statement stmt = (Statement) conn.createStatement();
						String query ="select * from Customer where climmit>15000";
